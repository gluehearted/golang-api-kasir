...
// CategoryRepository menangani operasi database untuk kategori
type CategoryRepository struct {
	db *sql.DB
}

// NewCategoryRepository membuat CategoryRepository dengan injected database connection
...
// Create membuat kategori baru di database
...
// Update memperbarui kategori di database
